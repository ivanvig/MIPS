...
create_clock -add -name sys_clk_pin -period 100.00 -waveform {0 50} [get_ports { CLK100MHZ }];
...
#set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { eth_        rstn }]; #IO_L20P_T3_A20_15 Sch=eth_rstn
